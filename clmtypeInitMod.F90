...
!-----------------------------------------------------------------------
! MODIFICATIONS TO THIS MODULE TAKE PLACE ON LINES 871-877 AND 986-998 
!-----------------------------------------------------------------------
...
! Adding...
    ...
    allocate(pps%tlai_dust(beg:end))
    allocate(pps%tsai_dust(beg:end))
