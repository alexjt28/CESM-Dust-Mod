...
!-----------------------------------------------------------------------
! MODIFICATIONS TO THIS MODULE BEING ON LINE 172 AND END ON LINE 184
!-----------------------------------------------------------------------
...
! Adding...
   ...
   real(r8), pointer :: tlai_dust(:)            !same as tlai, but for the dust model
...
! Adding...
   ...
   real(r8), pointer :: tsai_dust(:)            !same as tsai, but for the dust model
