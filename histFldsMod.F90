...
!-----------------------------------------------------------------------
! MODIFICATIONS FOR THIS MODULE TAKE PLACE ON LINES 520-531 
!-----------------------------------------------------------------------
...
! Adding...
    ...
    call hist_addfld1d (fname='TLAI_DUST', units='none', &
         avgflag='A', long_name='total projected leaf area index for dust', &
         ptr_pft=pps%tlai_dust)

    call hist_addfld1d (fname='TSAI_DUST', units='none', &
         avgflag='A', long_name='total projected stem area index for dust', &
         ptr_pft=pps%tsai_dust)
